...
def init_ff(dataset='all',phase='test'):
	...
	original_path='/media/Data8T/hanss/DeepfakeBench-main/datasets/FaceForensics++/original_sequences/youtube/raw/videos/'
	folder_list = sorted(glob(original_path+'*'))

	list_dict = json.load(open(f'/media/Data8T/hanss/DeepfakeBench-main/datasets/FaceForensics++/{phase}.json','r'))
	filelist=[]
	for i in list_dict:
		filelist+=i
	...
	folder_list=[]
	for fake in fakes:
		fake_path=f'/media/Data8T/hanss/DeepfakeBench-main/datasets/FaceForensics++/manipulated_sequences/{fake}/raw/videos/'
...
def init_dfd():
	real_path='/media/Data8T/hanss/DeepfakeBench-main/datasets/FaceForensics++/original_sequences/actors/raw/videos/*.mp4'
	real_videos=sorted(glob(real_path))
	fake_path='/media/Data8T/hanss/DeepfakeBench-main/datasets/FaceForensics++/manipulated_sequences/DeepFakeDetection/raw/videos/*.mp4'
...
def init_cdf():
	...
	video_list_txt='/media/Data8T/hanss/Celeb-DF-v2/List_of_testing_videos.txt'
	with open(video_list_txt) as f:
		...
		for data in f:
			...
			# print(line)
			path=line[1].split('/')
			folder_list+=['/media/Data8T/hanss/Celeb-DF-v2/'+path[0]+'/videos/'+path[1]]
