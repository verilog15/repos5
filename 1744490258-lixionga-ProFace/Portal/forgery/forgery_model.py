...
class Detector(nn.Module):
    ...
    def __init__(self):
        ...
        weight_path = '/home/chenyidou/x_test/web/forgery/weights/adv-efficientnet-b4-44fb3a87.pth'
        ...
        weight = torch.load('/home/chenyidou/x_test/web/forgery/weights/backbone.pth', map_location=device)
