...
class Mobile_face:
    def __init__(self,id_emb,id_feature):
        ...
        weight = torch.load('/home/chenyidou/x_test/web/checkpoints/model.pth')
    ...
    def img_swap(self, img):
        ...
        face,back_matrix = align_img(image,landmark)
        ...
        out = dealign(res, image, back_matrix, mask)
