...
class MakeupPrivacy:
    def __init__(self):
        ...
        n_classes = 19
        parsing_net = BiSeNet(n_classes=n_classes)
        parsing_net.load_state_dict(torch.load('/home/chenyidou/x_test/web/Makeup-privacy/79999_iter.pth', map_location=torch.device('cpu')))
        parsing_net.eval()
        for param in parsing_net.parameters():
            param.requires_grad = False
    ...
    def forward(self, image):
        source_image = cv2.imread('/home/chenyidou/x_test/web/Makeup-privacy/imgs/reference/ref05.png')
...
if __name__ == '__main__':
    model = MakeupPrivacy()
    out = model.forward('/home/chenyidou/x_test/web/Makeup-privacy/imgs/source_img/000291.jpg')
    cv2.imwrite('/home/chenyidou/x_test/web/Makeup-privacy/imgs/save_img/000001.jpg', out)
