...
import argparse
import os
from Makeupprivacy.util import util
...
import torch
import Makeupprivacy.models as models
import Makeupprivacy.data as data
# import data
import pickle
import importlib
...
def find_dataset_using_name(dataset_name):
    ...
    # will be imported. 
    dataset_filename = "Makeupprivacy.data." + dataset_name + "_dataset"
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='1_facenet_multiscale=2', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--target_path', type=str, default='/home/chenyidou/x_test/web/Makeupprivacy/imgs/reference/ref06.png',help='The face ID of the victim')
        parser.add_argument('--gpu_ids', type=str, default='-1', help='gpu ids: e.g. 0, 0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/home/chenyidou/x_test/web/Makeupprivacy/checkpoints', help='models are saved here')
        ...
        #fr_models
        parser.add_argument('--train_models', type=list, default=['mobile_face','facenet','irse50'], help='Models involved in training')
        parser.add_argument('--test_model', type=list, default=['ir152'],help='Models involved in training')
        ...
        parser.add_argument('--dirmap', type=str, default='./MT-Dataset/segs', help='path to parsing maps)')
    ...
    def gather_options(self):
        ...
        dataset_option_setter = get_option_setter(dataset_mode)
