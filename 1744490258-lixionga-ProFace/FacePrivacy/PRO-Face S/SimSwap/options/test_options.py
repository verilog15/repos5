...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default=c.DIR_ARC_PATH, help="run ONNX model via TRT")
        self.parser.add_argument("--pic_a_path", type=str, default='', help="Person who provides identity information")
        self.parser.add_argument("--pic_b_path", type=str, default='', help="Person who provides information other than their identity")
        ...
        self.parser.add_argument('--use_mask', action='store_true', default=True, help='Use mask for better result')
