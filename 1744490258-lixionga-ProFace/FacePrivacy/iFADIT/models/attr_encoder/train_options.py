...
import sys
import os
# sys.path.append("/data/lk/ID-disen4/configs")
...
class TrainOptions:
	...
	def initialize(self):
		...
		#gen fixed image
		# self.parser.add_argument('--src_image_dir', type=str, default=None, required=True)
		# self.parser.add_argument('--mask_dir', type=str, default=None, required=True)
		# self.parser.add_argument('--fixed_image_dir', type=str, default=None, required=True)
