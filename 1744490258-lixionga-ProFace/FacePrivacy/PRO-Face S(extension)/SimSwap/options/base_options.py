...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default=c.latest_G_dir, help='models are saved here')
        ...
        self.parser.add_argument('--netG', type=str, default=c.DIR_SIMSWAP_NET_G, help='selects model to use for netG')
        ...
        self.parser.add_argument('--image_size', type=int, default=512, help='number of clusters for features')
